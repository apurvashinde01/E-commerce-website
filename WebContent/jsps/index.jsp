...
<form class="example" action="${pageContext.request.contextPath }/Search" style="margin:auto;max-width:600px">
  ...
  <button type="submit"><i class="fa fa-search"></i></button>
		...
		<div class="main_slider"
			style="background-image: url(resources/images/slider1.jpg)">
					...
					<div class="col">
						<div class="main_slider_content">
							...
							<div class="red_button shop_now_button">
								<a href="${pageContext.request.contextPath }/Categories?cat=2">shop
									now</a>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="banner_item align-items-center"
							...
							<div class="banner_category">
								<a href="${pageContext.request.contextPath }/Categories?cat=1">girl's</a>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="banner_item align-items-center"
							...
							<div class="banner_category">
								<a href="${pageContext.request.contextPath }/Categories?cat=2">generic's</a>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="banner_item align-items-center"
							...
							<div class="banner_category">
								<a href="${pageContext.request.contextPath }/Categories?cat=3">boy's</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="new_arrivals_sorting">
							<ul
								...
								<li
									...
									data-filter=".women">girl's</li>
								<li
									class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center"
									data-filter=".accessories">accessories</li>
								<li
									class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center"
									data-filter=".men">boy's</li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="product-grid"
							...
							<div class="product-item men">
								<div class="product discount product_filter">
									...
									<div class="product_info">
										<h6 class="product_name">
											<a href="${pageContext.request.contextPath }/Single?prod=1">Deluxe
												Magic Boys Bike</a>
										</h6>
								...
								<div class="red_button add_to_cart_button">
									<a href="${pageContext.request.contextPath }/ShowCart?prod=2">add
										to cart</a>
								</div>
							</div>
							...
							<div class="product-item women">
								<div class="product product_filter">
									...
									<div class="product_info">
										<h6 class="product_name">
											<a href="${pageContext.request.contextPath }/Single?prod=2">battery
							...
							<div class="product-item women">
								<div class="product product_filter">
									<div class="product_image">
										<img src="resources/images/product31.jpeg" alt="">
									</div>
									<div class="favorite"></div>
									<div class="product_info">
										<h6 class="product_name">
											<a href="${pageContext.request.contextPath }/Single?prod=3">Barbie
												DOLL & ACCESSORIES</a>
										</h6>
							...
							<div class="product-item accessories">
								<div class="product product_filter">
									...
									<div class="product_info">
										<h6 class="product_name">
											<a href="${pageContext.request.contextPath }/Single?prod=4">Doraemon
							...
							<div class="product-item women men">
								<div class="product product_filter">
									...
									<div class="product_info">
										<h6 class="product_name">
											<a href="${pageContext.request.contextPath }/Single?prod=5">Rabbit
												Cuppy Cake Pram </a>
										</h6>
								...
								<div class="owl-item product_slider_item">
									<div class="product-item">
										<div class="product discount">
											<div class="product_image">
												<img src="resources/images/product_10.jpeg" alt="">
											</div>
											<div class="favorite favorite_left"></div>
											<div
												class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center">
